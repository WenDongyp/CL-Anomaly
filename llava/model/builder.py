    ...
    if "llava" in model_name.lower() or is_multimodal:
        ...
        if "lora" in model_name.lower() and model_base is not None:
            ...
            if "mixtral" in model_name.lower():
                ...
                if "7b" in model_base.lower():
                    print(f"[INFO] Detected 7B model in {model_base}, fixing vocab_size -> 152064")
            ...
            from CLADMoE.peft import PeftModel

            rank0_print("Loading CL-AnomalyLoRA weights...")
            model = PeftModel.from_pretrained(model, model_path)
            rank0_print("Merging CL-AnomalyLoRA weights...")
